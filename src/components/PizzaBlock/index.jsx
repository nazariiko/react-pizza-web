...
function PizzaBlock({ id, imageUrl, name, price, types, sizes, onAddPizzaToCart }) {
    ...
    <div className="pizza-block">
      ...
      <div className="pizza-block__bottom">
        ...
        <Button onClick={handleAddPizza} className="button--add" outline>
          ...
          <span>Добавить</span>
          {cartItems[id] && cartItems[id].totalCountById ? (
            <i>{cartItems[id].totalCountById}</i>
          ) : (
            ''
          )}
        </Button>
